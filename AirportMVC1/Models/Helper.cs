...
using static AirportMVC1.Models.Repositories.PassengerRepository;
using static AirportMVC1.Models.Repositories.TicketRepository;

using static AirportMVC1.Models.entity.Flight;
...
namespace AirportMVC1.Models
{
    public static class Helper
    {
        ...
        internal static IEnumerable <Flight> BuildInitialFlights()
        {
        ...
        internal static IEnumerable <Ticket> BuildInitialTickets()
        {
        ...
        internal static IEnumerable <Passenger> BuildInitialPassengers()
        {
